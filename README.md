...
The Enterprise Security Lab is a self-hosted enterprise security environment designed to simulate the technologies and workflows commonly found in small Security Operations Centers (SOC).
...
- 1 Elastic Stack server
- 1 Fleet Server
- Windows 11 endpoints
- Rocky Linux systems
- Sysmon telemetry
- 30 custom detection rules
- Incident response and investigation runbooks
- NIST CSF and NIST SP 800-171 documentation
...
| 05-Certificate-Authority-PKI.md   | Completed     |                                                                                                                       |
| 06-Server-Build-Standards.md      | Completed     |                                                                                                                       |
...
| 14-Vulnerability-Management.md    | Completed     |                                                                                                                       |
| 15-Patch-Management.md            | Completed     |                                                                                                                       |
| 16-Incident-Response.md           | Completed     |                                                                                                                       |
| 17-Investigation-Runbooks.md      | Completed     |                                                                                                                       |
| 18-Backup-Recovery.md             | Completed     |                                                                                                                       |
| 19-Security-Hardening.md          | Completed     |                                                                                                                       |
| 20-NIST-CSF-Mapping.md            | Completed     |                                                                                                                       |
...
- Centralized telemetry collection across Windows and Linux systems
- Detection engineering mapped to MITRE ATT&CK
- Incident investigation and response workflows
- Identity, PKI, and endpoint security management
- NIST SP 800-171 control mapping and documentation
- SIEM administration and security monitoring
